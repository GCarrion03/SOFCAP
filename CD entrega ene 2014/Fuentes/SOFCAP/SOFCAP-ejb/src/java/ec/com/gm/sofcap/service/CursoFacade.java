...
public class CursoFacade extends AbstractFacade<Curso> {
    ...
    public void actualizarCursoN1(Curso cursoActualizar,Collection<Asistencia> asistentes) throws Exception{
         cursoActualizar.setPlantillaCurso(null);
            cursoActualizar.setInstructor(null);
        Curso cursoActTmp =em.find(Curso.class, cursoActualizar.getIdCurso());    
        cursoActTmp.setResN1(cursoActualizar.getResN1());
        em.persist(cursoActTmp);
    }
...
//         criterioBusqueda.createAlias("cursosevaluacionCollection", "cursosevaluacionCollection");
//         criterioBusqueda.createAlias("cursosevaluacionCollection.plantillaEvaluacion", "plantillaEvaluacion");
