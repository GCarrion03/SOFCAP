...
public class NuevaCapacitacionDataManager implements Serializable{
    ...
    private List<SelectItem> listaPrincipios,listaTipoCurso,listaTemas,listaTurnos,listaInstructores,listaCentroEntren,listaPlanificacionCursos,listaCmbAreas,listaCecos;
